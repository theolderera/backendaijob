...
const org_member_controller_1 = require("./org-member.controller");
...
exports.OrganizationsModule = OrganizationsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([organization_entity_1.Organization, org_member_entity_1.OrgMember])],
        controllers: [organizations_controller_1.OrganizationsController, org_member_controller_1.OrgMemberController],
